...
public class TestHelper {
	...
	public static final String PRINT_STATEMENT_TEST_EXPERTED_1 = "Operation : Deposit, TimeStamp : "
			+ TestHelper.LDT_STRING + ", Amount : 10, Balance : 10";
	public static final String PRINT_STATEMENT_TEST_EXPERTED_2 = "Operation : Withdraw, TimeStamp : "
			+ TestHelper.LDT_STRING + ", Amount : 1, Balance : 9";
	...
	public static void testBankRecord(BankRecord br, String operation, String amount, String balance,
			String timestamp) {
