...
public class TddMainTest {
	...
	public void takeDepositTest() throws BankAccountNotFoundException, InvalideTransactionException {
		...
		TestHelper.testBankRecord(br, TestHelper.DEPOSIT, BigDecimal.ONE.toString(),
				BigDecimal.ONE.toString(), TestHelper.LDT_STRING);
	}
	...
	public void makeWithdrawTest() throws BankAccountNotFoundException, InvalideTransactionException {
		...
		TestHelper.testBankRecord(br, TestHelper.WITHDRAW, BigDecimal.ONE.toString(),
				BigDecimal.ZERO.toString(), TestHelper.LDT_STRING);
	}
	...
	public void getStatementTest() throws BankAccountNotFoundException, InvalideTransactionException {
		...
		TestHelper.testBankRecord(brs.get(0), TestHelper.DEPOSIT, BigDecimal.TEN.toString(),
				BigDecimal.TEN.toString(), TestHelper.LDT_STRING);
		TestHelper.testBankRecord(brs.get(1), TestHelper.WITHDRAW, BigDecimal.ONE.toString(),
