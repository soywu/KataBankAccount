...
public class Withdraw extends BankTransaction {
	...
	public static Withdraw of(BigDecimal amount, int withdrawFromAccountId) {
		return new Withdraw(TimeProvider.now(), amount, withdrawFromAccountId);
	}

	private Withdraw(LocalDateTime transactionTime, BigDecimal amount, int withdrawFromAccountId) {
